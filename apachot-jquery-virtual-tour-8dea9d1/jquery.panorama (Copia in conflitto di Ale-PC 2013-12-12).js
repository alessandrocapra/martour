...
(function($) {
	$.fn.panorama = function(options) {
		this.each(function(){ 
			...
			panoramaContainer.css('height', elemHeight+'px').css('overflow', 'hidden').wrap("<div class='panorama-viewport effect7'></div>").parent().css('width',settings.viewport_width+'px')
